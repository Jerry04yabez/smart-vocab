...
def process_word(word: str, language: str, hashtable: 'HashTable',
    ...
    try:
        ...
        prompt = (
            'You are a vocabulary learning assistant. Analyze the word "' + word + '" and return ONLY a valid JSON object with these exact fields:\n'
            '{\n'
            ...
            '- Level 1: Very common, basic words (e.g., "cat", "run", "good")\n'
            '- Level 2: Common words in everyday use (e.g., "beautiful", "understand", "quickly")\n'
            '- Level 3: Moderately common words, some complexity (e.g., "elaborate", "significant", "consider")\n'
            '- Level 4: Less common, advanced vocabulary (e.g., "meticulous", "eloquent", "scrutinize")\n'
            '- Level 5: Rare, highly specialized or complex words (e.g., "serendipity", "perspicacious", "ubiquitous")\n'
            'Assess the difficulty based on word frequency, complexity, and typical usage. Return ONLY the JSON object. No markdown, no explanations, no additional text.'
        )
